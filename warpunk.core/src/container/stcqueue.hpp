...
/** */
template<typename T>
warpunk_api inline stcqueue<T> stcqueue_create(s64 size)
{
    if (size <= 0)
    {
        size = 1;
...
/** */
template<typename T>
warpunk_api inline void stcqueue_destroy(stcqueue<T>* queue)
{   
...
/** */
template<typename T>
warpunk_api inline b8 stcqueue_enqueue(stcqueue<T>* queue, T element)
{
...
/** */
template<typename T>
warpunk_api inline T stcqueue_dequeue(stcqueue<T>* queue)
{
...
/** */
template<typename T>
warpunk_api inline void stcqueue_clear(stcqueue<T>* queue)
{
